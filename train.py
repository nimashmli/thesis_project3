...
class Trainer:
    def __init__(self, model, train_loader, test_loader, device,label_method,
                 ...
                 status_path=None, verbose=False, save_each_epoch=True):
        """
    ...
    def _save_status(self, epoch, status="running"):
    ...
    def _save_checkpoint(self, epoch):
        ...
        self._save_status(epoch, status="running")
    ...
    def fit(self):
        ...
        # status نهایی
        self._save_status(self.epochs, status="completed")
